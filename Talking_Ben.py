...
wait for more comments in a bit 
...
def speak():
    ...
    pygame.mixer.music.load('ben-101soundboards.mp3')
    ...
    def ben_answer():
        ...
        if answer == 1:
            pygame.mixer.music.load('yes-101soundboards.mp3')
            pygame.mixer.music.play()
            while pygame.mixer.music.get_busy():
                pygame.time.Clock().tick(10)
        elif answer == 2:
            pygame.mixer.music.load('no-101soundboards.mp3')
            pygame.mixer.music.play()
            while pygame.mixer.music.get_busy():
                pygame.time.Clock().tick(10)
        elif answer == 3:
            pygame.mixer.music.load('uhh-101soundboards.mp3')
            pygame.mixer.music.play()
            while pygame.mixer.music.get_busy():
                pygame.time.Clock().tick(10)
        elif answer == 4:
